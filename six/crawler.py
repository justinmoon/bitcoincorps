...
from network import Address, AddrMessage, NetworkEnvelope
...
class Connection:
    ...
    def handle_addr(self, packet):
        addr_message = AddrMessage.parse(io.BytesIO(packet.payload))
    ...
    def handle_packet(self, packet):
        ...
        print(f"{self.worker} received {packet.command}")
...
class Worker(threading.Thread):
    ...
    def run(self):
        ...
        while True:
            ...
            print(f"{self.name} finished connection")
...
class Crawler:
    ...
    def save_connection_outcome(self, connection):
        ...
        if connection.addr_message:
            x = AddrMessage.parse(io.BytesIO(connection.addr_message))
    ...
    def crawl(self):
        ...
        while True:
            ...
            while self.connection_queue.qsize():
                ...
                print("crawler received outcome")
